...
public class HttpClient4 implements net.oauth.http.HttpClient {
	...
	public HttpResponseMessage execute(HttpMessage request, Map<String, Object> parameters) throws IOException {
		...
		AppDatabase.writeLog("00001: "+url);
		...
		if (isPost || isPut) {
			AppDatabase.writeLog("00001: isPost || isPut");
			...
			AppDatabase.writeLog("00001: isDelete");
			httpRequest = new HttpDelete(url);
		} else {
			AppDatabase.writeLog("00001: default");
		...
		AppDatabase.writeLog("00001: Calling client.execut(httpRequest)");
		HttpResponse httpResponse = client.execute(httpRequest);
		AppDatabase.writeLog("00001: Rertrieved httpResponse");
