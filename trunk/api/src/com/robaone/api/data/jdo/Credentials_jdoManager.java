...
public class Credentials_jdoManager {
  ...
  private final static String SELECT = "select ~ from #TABLE# #OPTION#  where idcredentials = ?";
  ...
  public Credentials_jdo bindCredentials(ResultSet rs) throws SQLException{
...
*/
  ...
  public void save(Credentials_jdo record,boolean dirty) throws Exception {
    ...
    try{
      ...
      // Update
        ...
        record.setIdcredentials(new Integer(NEXT_SQL.getIdentity(this.getTableName(),this.m_con).toString()));
        finished = true;
        if(updated == 0){
...
Credentials_jdo retval = new Credentials_jdo();
 ...
 return retval;
  ...
  public JSONObject toJSONObject(Credentials_jdo record) throws Exception {
  ...
  public void bindCredentialsJSON(Credentials_jdo record,String jsondata) throws Exception {
    JSONObject jo = new JSONObject(jsondata);
    bindCredentialsJSON(record,jo);
  }
  public void bindCredentialsJSON(Credentials_jdo record, JSONObject jo) throws Exception {
