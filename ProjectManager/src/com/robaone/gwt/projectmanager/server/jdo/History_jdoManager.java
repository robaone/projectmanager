...
public class History_jdoManager {
	...
	public History_jdoManager(Connection con){
		this.m_con = con;
		try{
	...
	public static History_jdo bindHistory(ResultSet rs) throws SQLException{
		History_jdo retval = null;
		retval = History_jdoManager.createObject(rs);
		return retval;
	}

	public History_jdo getHistory(BigDecimal id){
	 ...
	 * @throws SQLException
	 */
	private static History_jdo createObject(ResultSet rs) throws SQLException {
		History_jdo retval = null;
		retval = new History_jdo();
		/*
		 *
	...
	public void save(History_jdo record) throws Exception {
	...
	private int getSQLType(String fieldname) {
		...
		map.put(History_jdo.ID, java.sql.Types.NUMERIC);
		map.put(History_jdo.OBJECTID, java.sql.Types.NUMERIC);
		map.put(History_jdo.NAME, java.sql.Types.VARCHAR);
		map.put(History_jdo.PARENT, java.sql.Types.NUMERIC);
		map.put(History_jdo.TYPE, java.sql.Types.INTEGER);
		map.put(History_jdo.TITLE, java.sql.Types.VARCHAR);
		map.put(History_jdo.DESCRIPTION, java.sql.Types.CLOB);
		map.put(History_jdo.STRING_VALUE, java.sql.Types.VARCHAR);
		map.put(History_jdo.NUMBER_VALUE, java.sql.Types.NUMERIC);
		map.put(History_jdo.BOOL_VALUE, java.sql.Types.TINYINT);
		map.put(History_jdo.DATE_VALUE,java.sql.Types.TIMESTAMP);
		map.put(History_jdo.TEXT_VALUE, java.sql.Types.CLOB);
		map.put(History_jdo.BINARY_VALUE, java.sql.Types.BLOB);
		map.put(History_jdo.CONTENT_TYPE, java.sql.Types.VARCHAR);
		map.put(History_jdo.MODIFIED_BY, java.sql.Types.VARCHAR);
		map.put(History_jdo.MODIFIED_DATE,java.sql.Types.TIMESTAMP);
		map.put(History_jdo.MODIFIER_HOST, java.sql.Types.VARCHAR);
		return ((Integer)map.get(fieldname)).intValue();
	}
	protected void handleAfterInsert(History_jdo record) {}
	protected void handleAfterUpdate(History_jdo record) {}
	protected void handleBeforeUpdate(History_jdo record) {}
	private void setAllClean(History_jdo record){
		try{
			for(int i = 0; i < record.getFieldCount();i++){
				String fieldname = record.getField(i);
				Object[] val = record.getField(fieldname);
	...
	public void delete(History_jdo record) throws Exception {
		Connection con = this.getConnection();
	...
	public History_jdo newHistory() {
		History_jdo retval = new History_jdo();
		retval.setId(null);
		return retval;
	}
